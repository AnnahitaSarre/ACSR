...
#SBATCH --chdir=/network/lustre/iss02/cohen/data/Annahita/ACSR/code
#SBATCH --output=logs/%j.out.log
#SBATCH --error=logs/%j.err.log
#SBATCH --job-name=acsr
...
python find_onsets.py --gender $gender --cropping $cropping --path2video $path2test_videos --fn-video $1 --model-type $model_type --textgrid
